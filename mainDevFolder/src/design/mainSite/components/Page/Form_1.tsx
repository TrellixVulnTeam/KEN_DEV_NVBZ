...
export const Form_1 = (props) => {

    const [registration , setRegistration] = React.useState(false)
    console.log(props.match.params.client)
...
<React.Fragment>
 ...
 <Result
    ...
    subTitle={<p><span className='formSpan'>{}</span>, We at kcm inc are proud to provide you and 
    ...
    extra={[
      ...
      <motion.button whileHover={{backgroundColor:'#b8862369'}} className='button'  key="buy">Next</motion.button >,
    ]}
  />
    </motion.div> 
